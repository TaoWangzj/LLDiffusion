...
class ImageEmbedder(nn.Module):
    """
    Embeds images into vector representations.
    """

    def __init__(self, img_size, patch_size, in_chans, hidden_size, norm_layer=None):
        super().__init__()
        self.patch_embed = PatchEmbed(
            img_size=img_size, patch_size=patch_size, in_chans=in_chans, embed_dim=hidden_size, norm_layer=norm_layer)
